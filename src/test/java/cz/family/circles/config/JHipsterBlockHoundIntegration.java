package cz.family.circles.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("cz.family.circles.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("cz.family.circles.security.DomainUserDetailsService", "createSpringSecurityUser");
